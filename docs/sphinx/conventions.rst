...
- One walk step ``W = R U_A`` (encoding, then reflection
  ``R = I - 2|0><0|``) block-encodes **-H/alpha**; its eigenphases are
...
- the **gate** `common_kernels.reflect_about_zero` is
  ``I - 2|0..0><0..0|`` (the all-zero state acquires `-1`);
